...
REQUIRED_PKGS="ca-certificates binutils libasound2-dev libpcre3-dev libidn11-dev libboost-dev libfreetype6-dev libdbus-1-dev libssh-dev libsmbclient-dev gcc g++ sed pkg-config"
MISSING_PKGS=""
